# Guida docente — 20. Capstone: consegna robotica

Durata prevista: 120 minuti. Difficoltà: C.

## Evidenze osservabili

Lo studente sa progettare, testare e spiegare una missione completa, anticipa l'effetto delle istruzioni e interpreta almeno un
risultato del grader. La consegna è: Raggiungi i checkpoint, evita collisioni, fermati nel parcheggio e consegna una breve spiegazione.
...
- 40–120 min: verifica automatica, spiegazione orale e exit ticket.
...
debrief collegare funzioni, cicli, condizioni, grading alla prossima unità, evitando dettagli interni del backend.
