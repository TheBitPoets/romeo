# Guida docente — 13. Progetta una sequenza

Durata prevista: 60 minuti. Difficoltà: B.

## Evidenze osservabili

Lo studente sa ordinare azioni e durate per una missione, anticipa l'effetto delle istruzioni e interpreta almeno un
risultato del grader. La consegna è: Avanza, ruota a sinistra, avanza ancora e fermati.
...
debrief collegare algoritmo, ordine, stato alla prossima unità, evitando dettagli interni del backend.
