...
Lo studente sa eseguire il primo programma e fermare il robot, anticipa l'effetto delle istruzioni e interpreta almeno un
risultato del grader. La consegna è: Accendi il LED blu, invia un breve comando avanti e termina con stop.
...
debrief collegare programma, istruzione, simulatore alla prossima unità, evitando dettagli interni del backend.
