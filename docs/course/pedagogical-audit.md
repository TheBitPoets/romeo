...
| 2 | U21–U23 | Riscritte: safety, integrazione e telepresenza con rubriche, prove negative e responsabilità di sistema. |
...
Hint e worksheet derivano dallo stesso contenuto specifico, non rivelano la
soluzione e chiedono una previsione e un'evidenza osservabile.
...
threat model; presentarli come sicuri nello stesso interprete sarebbe
fuorviante.
